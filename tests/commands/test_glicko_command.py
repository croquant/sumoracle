...
class GlickoCommandTests(TestCase):
    ...
    def test_ratings_are_computed(self):
        ...
        self.assertEqual(r1_b1.previous_rating, 1500.0)
        self.assertEqual(r1_b1.previous_rd, 350.0)
        self.assertEqual(r1_b1.previous_vol, 0.11)
        self.assertEqual(r2_b1.previous_rating, 1500.0)
        self.assertEqual(r2_b1.previous_rd, 350.0)
        self.assertEqual(r2_b1.previous_vol, 0.11)
        self.assertAlmostEqual(r1_b2.rating, r1_b1.rating, places=5)
        self.assertAlmostEqual(r2_b2.rating, r2_b1.rating, places=5)
        self.assertAlmostEqual(r1_b2.previous_rating, r1_b1.rating, places=5)
        self.assertAlmostEqual(r1_b2.previous_rd, r1_b1.rd, places=5)
        self.assertAlmostEqual(r1_b2.previous_vol, r1_b1.vol, places=5)
        self.assertAlmostEqual(r2_b2.previous_rating, r2_b1.rating, places=5)
        self.assertAlmostEqual(r2_b2.previous_rd, r2_b1.rd, places=5)
        self.assertAlmostEqual(r2_b2.previous_vol, r2_b1.vol, places=5)
